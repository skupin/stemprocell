...
<!--                    </div>-->
                    ...
                    <div class="col-md-4 text-center">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="usuario@ejemplo.com">
...
<!--                    <div class="col-md-2 col-sm-4"><img src="img/ministerio-de-salud-publica.png" alt=""></div>-->
            ...
            <div class="row">
                <div class="col-12 col-md text-center">
                    <hr>
                    <small class="d-block mb-3 text-muted align-text-bottom">&copy; 2017-2018 Todos los derechos reservados.</small>
                </div>
            </div>

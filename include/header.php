...
<div class="container">
    <div class="col-md-12 d-flex flex-row-reverse">
        <ul class="navbar-nav flex-row">
            <li class="nav-item"><a class="nav-link px-2" href="#"><span class="fa fa-telephone">809-555-6666</span></a></li>
...
<!--            </ul>-->
        ...
        <div class="collapse navbar-collapse" id="mainNav">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item <?php if ( $pageName === 'nosotros.php') { echo ' active';} ?>">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="terapias">
                        <a class="dropdown-item <?php if ( $pageName === 'tratamientos_clinicos.php') { echo ' active';} ?>" href="tratamientos_clinicos.php">Uso Clinico</a>
                        ...
                        <a class="dropdown-item <?php if ( $pageName === 'tratamientos_ort_trm.php') { echo ' active';} ?>" href="tratamientos_ort_trm.php">Uso en Ortopedia y Traumatologia</a>
                    </div>
                </li>
                <li class="nav-item <?php if ( $pageName === 'faq.php') { echo ' active';} ?>">
                    <a class="nav-link" href="faq.php">Preguntas frecuentes</a>
                </li>

                <li class="nav-item <?php if ( $pageName === 'testimonios.php') { echo ' active';} ?>">
                    <a class="nav-link" href="testimonios.php">Testimonios</a>
                </li>
                <li class="nav-item <?php if ( $pageName === 'instalaciones.php') { echo ' active';} ?>">
                    <a class="nav-link" href="instalaciones.php">Instalaciones</a>
                </li>
                <li class="nav-item <?php if ( $pageName === 'contacto.php') { echo " active";} ?>">
